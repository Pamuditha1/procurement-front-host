...
import AdminOnePRItem from "./AdminOnePRItem";

function AdminViewPRItems({ selectedPR }) {
        ...
        <Table hover borderless className="mt-5">
          ...
          <tbody>
            {selectedPR.items.map((p, index) => {
              ...
              // }
              // setQ();
              return <AdminOnePRItem p={p} adtoPO={adtoPO} index={index} />;
            })}
          </tbody>
        </Table>
        <Link to="/admin/documents/prs">
...
export default AdminViewPRItems;
